...
export default function Home() {
  ...
  return (
    <>
        ...
        <div className="p-3 flex mob:flex-col m-auto max-w-6xl justify-between items-center">
          <div className="logo mob:border-b mob:border-b-gray-200 flex justify-center items-center">
            ...
            <div className="text flex flex-col justify-start items-start">
              ...
              <p className="text-xs"> Government College of Engineering Nagpur</p>
          ...
          <div className="links mob:py-3 flex justify-center items-center space-x-5">
            ...
            <Link href="https://www.linkedin.com/in/gdsc-gcoen-b04655221/"><div className="cursor-pointer linkedin">
            ...
            <Link href="https://www.instagram.com/gdscgcoen/"><div className="cursor-pointer insta">
      ...
      <div className="  w-full p-2 text-center bg-gray-900 text-gray-300">Devloped By <a href="" className="text-orange-400">Shiwang Pandey</a> </div>
    </>
  )
}
